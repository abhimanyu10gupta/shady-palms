...
const About = () => {
  return (
    <div className='text-white w-full flex p-24 pl-48 md:flex-col sm: flex-col lg:flex-row'>
        <div className='basis-1/3'>
          <h1 className='font-bold text-6xl p-2'>   
              About    
          </h1>
          <p className='text-sm p-2 flex justify-end pr-10'>
            Your local Stocos Bar
          </p>
        </div>
            
        <div className='basis-2/3 text-md flex items-center pl-12'>
            <p>
